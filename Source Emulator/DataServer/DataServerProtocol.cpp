		...
		case 0xA0:
			switch(((lpMsg[0]==0xC1)?lpMsg[3]:lpMsg[4]))
			{
				...
				case 0x03:
					...
					break;
				case 0x04:
					gGuild.GDGuildMemberBreakRecv((SDHP_GUILD_MEMBER_BREAK_RECV*)lpMsg,index);
					break;
				case 0x05:
					gGuild.GDGuildMemberGetInfoRecv((SDHP_GUILD_MEMBER_GET_INFO_RECV*)lpMsg,index);
					break;
				case 0x06:
					gGuild.GDGuildAssignStatusRecv((SDHP_GUILD_ASSIGN_STATUS_RECV*)lpMsg,index);
					break;
				case 0x07:
					gGuild.GDGuildAssignTypeRecv((SDHP_GUILD_ASSIGN_TYPE_RECV*)lpMsg,index);
					break;
				case 0x08:
				...
				case 0x11:
					...
					break;
				case 0x12:
					gGuild.GDGuildUnionListRecv((SDHP_GUILD_UNION_LIST_RECV*)lpMsg,index);
					break;
				case 0x13:
