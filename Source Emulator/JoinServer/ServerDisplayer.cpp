...
void CServerDisplayer::SetWindowName() // OK
{
	...
	wsprintf(buff,JOINSERVER_VERSION,JOINSERVER_UPDATE,PROTOCOL_NAME,(state == 0)?"STANDBY":"ACTIVE");
...
void CServerDisplayer::PaintBarInfo() // OK
{
	...
	wsprintf(buff,"UserCount: %d/%d",gAccountManager.GetAccountCount(),gJoinServerMaxAccount[4]);
