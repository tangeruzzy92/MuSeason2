...
void CDoubleGoer::SetStage2() // OK
{
	...
	this->NoticeSendToAll(0,gMessage.GetMessage(147));
...
bool CDoubleGoer::AddUser(int aIndex) // OK
{
	...
	for(int n=0;n < MAX_DG_USER;n++)
	{
		...
		gObjEventEntrySaveSend(&gObj[aIndex],3);
		return 1;
	}
...
void CDoubleGoer::NpcSartiganTheAngel(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	if(lpObj->Level < 10)
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0,gMessage.GetMessage(148));
		return;
	}
...
void CDoubleGoer::NpcSilverRewardChest(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	{
	case 0:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,0,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
		break;
	case 1:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,1,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
		break;
	case 2:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,2,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
		break;
	case 3:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,3,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
		break;
	case 4:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,4,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
		break;
	default:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,5,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
		break;
	}
...
void CDoubleGoer::NpcGoldenRewardChest(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	{
		case 0:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,0,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 1:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,1,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 2:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,2,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 3:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,3,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 4:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,4,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		default:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_DOUBLE_GOER,5,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
	}
...
void CDoubleGoer::MonsterDieProc(LPOBJ lpObj,LPOBJ lpTarget) // OK
{
	...
	{
		this->m_IceWalkerIndex = -1;
		this->NoticeSendToAll(0,gMessage.GetMessage(149));
		return;
	}
...
void CDoubleGoer::CGDoubleGoerEnterRecv(PMSG_DOUBLE_GOER_ENTER_RECV* lpMsg,int aIndex) // OK
{
	...
	if(gServerInfo.m_DoubleGoerMaxEntryCount[lpObj->AccountLevel] != 0 && lpObj->DGCount >= gServerInfo.m_DoubleGoerMaxEntryCount[lpObj->AccountLevel])
	{
		GCNewMessageSend(aIndex,0,0,gMessage.GetMessage(716),gServerInfo.m_DoubleGoerMaxEntryCount[lpObj->AccountLevel]);
		return;
	}
