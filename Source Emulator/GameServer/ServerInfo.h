...
public:
	...
	int m_MaxConnectionIdle;
	int m_MaxConnectionPerIP;
	int m_MaxConnectionPerHID;
	int m_MaxPacketPerSecond;
	int m_MaxTimeConnectionVerify;
	int m_CheckSkillSpeedAction;
	int m_CheckSkillSpeedPenalty;
	...
	int m_PKItemDropRatePvP1;
	int m_PKItemDropRatePvP2;
	int m_PKItemDropRatePvP3;
	int m_PKItemDropRatePvM1;
	int m_PKItemDropRatePvM2;
	int m_PKItemDropRatePvM3;
	int m_PKItemDropMaxLevel;
	int m_PKItemDropPet;
	int m_PKItemDropWing;
	int m_PKItemDropExc;
	int m_PKItemDropSet;
	int m_PKItemDropJoH;
	int m_PKItemDrop380;
	...
	int m_ExperienceRandomAditional;
	int m_ItemDropTime;
