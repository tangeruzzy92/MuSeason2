...
void CImperialGuardian::GiveUserRewardExperience(int aIndex) // OK
{
	...
	if(this->m_Level == 3)
	{
		lpUser->RewardExperience = gServerInfo.m_ImperialGuardianRewardExperience1*((this->m_HighestLevel-1)/10);
	}
	else
	{
		lpUser->RewardExperience = gServerInfo.m_ImperialGuardianRewardExperience2*((this->m_HighestLevel-1)/10);
	}
...
void CImperialGuardian::NpcJerryTheAdviser(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	if(lpObj->Level < 15)
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0,gMessage.GetMessage(151));
		return;
	}
...
void CImperialGuardian::DropSideBossItem(LPOBJ lpObj,LPOBJ lpTarget) // OK
{
	...
	{
	case 0:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,0,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 1:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,1,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 2:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,2,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 3:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,3,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 4:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,4,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	default:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,5,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	}
...
void CImperialGuardian::DropMainBossItem(LPOBJ lpObj,LPOBJ lpTarget) // OK
{
	...
	{
	case 0:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,0,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 1:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,1,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 2:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,2,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 3:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,3,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	case 4:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,4,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	default:
		gItemBagManager.DropItemBySpecialValue(ITEM_BAG_IMPERIAL_GUARDIAN,5,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
		break;
	}
...
void CImperialGuardian::CGImperialGuardianEnterRecv(PMSG_IMPERIAL_GUARDIAN_ENTER_RECV* lpMsg,int aIndex) // OK
{
	...
	{
		GCNewMessageSend(aIndex,0,0,gMessage.GetMessage(718),gServerInfo.m_ImperialGuardianMaxEntryCount[lpObj->AccountLevel]);
		return;
	}
